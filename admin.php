...
if (!isset($_SESSION['admin_ID'])) {
    header("Location: admin_L.php"); // ✅ Redirect to login
    exit();
}
...
<div class="d-flex">
    ...
    <div class="sidebar d-flex flex-column p-3 text-white" style="width: 250px;">
        ...
        <ul class="nav nav-pills flex-column">
            ...
            <li><a href="admin_profile.php" class="nav-link"><i class="fas fa-user-edit me-2"></i>Edit Profile</a></li>
    ...
    <div class="flex-grow-1">
        ...
        <div class="admin-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Welcome, <?php echo $adminName; ?></h5>
                    ...
                    <div class="col-md-4">
                        <div class="card text-bg-primary">
                            <div class="card-body">
                                ...
                                <p class="card-text fs-4">-- count here --</p> <!-- Replace with dynamic PHP -->
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="card text-bg-warning">
                            <div class="card-body">
                                ...
                                <p class="card-text fs-4">₱ -- amount here --</p> <!-- Replace with dynamic PHP -->
                            </div>
                        </div>
                    </div>
                </div>
