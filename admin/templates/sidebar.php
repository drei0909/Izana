  ...
  <div class="sidebar p-3" id="sidebar">
    ...
    <ul class="nav nav-pills flex-column">
      ...
      <li>
        <a href="<?php echo BASE_URL; ?>admin/cashier.php" class="nav-link <?php echo ($active_page == 'cashier') ? 'active' : '' ?>">
          <i class="fas fa-cash-register me-2"></i>Online Cashier
        </a>
      </li>
      <li>
        <a href="<?php echo BASE_URL; ?>admin/manage_cashier.php" class="nav-link <?php echo ($active_page == 'manage_cashier') ? 'active' : '' ?>">
          <i class="fas fa-users-cog me-2"></i>POS
        </a>
      </li>
      <li>
        <a href="<?php echo BASE_URL; ?>admin/sales_report.php" class="nav-link <?php echo ($active_page == 'sales_report') ? 'active' : '' ?>">
          <i class="fas fa-chart-line me-2"></i>Sales Report
        </a>
      </li>
      <li>
        <a href="<?php echo BASE_URL; ?>admin/salesHistory.php" class="nav-link <?php echo ($active_page == 'salesHistory') ? 'active' : '' ?>">
